...
~~~sh
# getting the code
git clone git@github.com:nko4/refactoru.git && cd ./refactoru/

# developing
npm install
npm start

# deploying (to http://refactoru.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@refactoru.2013.nodeknockout.com
ssh root@refactoru.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@refactoru.2013.nodeknockout.com
ssh -i ./id_deploy root@refactoru.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/refactoru" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
